...
func (in *AtlasClusterService) DeepCopyInto(out *AtlasClusterService) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AtlasClusterService.
func (in *AtlasClusterService) DeepCopy() *AtlasClusterService {
	if in == nil {
		return nil
	}
	out := new(AtlasClusterService)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AtlasProjectService) DeepCopyInto(out *AtlasProjectService) {
	*out = *in
	if in.DBUserList != nil {
		in, out := &in.DBUserList, &out.DBUserList
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ClusterList != nil {
		in, out := &in.ClusterList, &out.ClusterList
		*out = make([]AtlasClusterService, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AtlasProjectService.
func (in *AtlasProjectService) DeepCopy() *AtlasProjectService {
	if in == nil {
		return nil
	}
	out := new(AtlasProjectService)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AtlasServiceStatus) DeepCopyInto(out *AtlasServiceStatus) {
	*out = *in
	in.Common.DeepCopyInto(&out.Common)
	if in.AtlasProjectServiceList != nil {
		in, out := &in.AtlasProjectServiceList, &out.AtlasProjectServiceList
		*out = make([]AtlasProjectService, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AtlasServiceStatus.
func (in *AtlasServiceStatus) DeepCopy() *AtlasServiceStatus {
	if in == nil {
		return nil
	}
	out := new(AtlasServiceStatus)
	in.DeepCopyInto(out)
	return out
}
